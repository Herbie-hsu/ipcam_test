...
check_type_flag()
{
	...
	do
		...
		elif [ "$type_temp" = "rootfs" ] || [ "$type_temp" = "driver" ] || [ "$type_temp" = "app" ] || [ "$type_temp" = "bootloader" ] || [  "$type_temp" = "kernel" ] || [  "$type_temp" = "tool" ] || [ "$type_temp" = "middleware" ] || [ "$type_temp" = "rootfs-bs" ]
		then
			if [ "$type_flag" = "0" ]
			then
				type_flag=1
...
function all_files_generate()
{
	...
	do
		...
		if [ "$cur_type_flag" = "driver" ] || [ "$cur_type_flag" = "app" ] || [ "$cur_type_flag" = "rootfs-bs" ] 
		then
