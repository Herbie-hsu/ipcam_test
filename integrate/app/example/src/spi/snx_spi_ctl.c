...
#define SPI_BITS_PER_WORD   8						/* 8 , 16  */
#define SPI_MAX_SPEED    	4000000 				/* 4MHz (MAX: 6MHz) */
#define SPI_DATA_NUM		8						/* How many data would be xfer */
#define SPI_DATA 			"0x00,0x00,0x01,0x01,0x02,0x01,0x03,0x00"				/* one byte by one byte, splitted by ",*/
...
int main(int argc, char *argv[])   
{
	...
	if ((ret != buf_size) && (op_mode != SPI_RD_OP_MODE)) {
		printf("[SNX-SPI] Wrong number of data\n");
		goto EXIT;
	}
