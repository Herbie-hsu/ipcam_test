...
static void usage(char *name)
{
  ...
  printf ("pwm_id:the value must be 0 or 1, 0 means use pwm1,1 means use pwm2\n");
	printf ("duty :duty keep time(Microseconds) must > 0\n");
	printf ("period :period time (Microseconds) must > 0\n");
}
