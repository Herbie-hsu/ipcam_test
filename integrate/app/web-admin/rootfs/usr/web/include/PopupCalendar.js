...
var current_date;
function PopupCalendar(InstanceName, strCurrentDate)
{
	///Global Tag
...
function CalendarInit()				///Create panel
{
	...
	/// Day
	htmloDayTable="<div><table id='"+this.sTABLEID+"'width='100%' border=0 cellpadding=0 cellspacing=1 bgcolor='"+this.tableBorderColor+"'>";
//htmloDayTable="<div><table id='"+this.sTABLEID+"' width='100%' border=0 cellpadding=0 cellspacing=1 bgcolor='"+this.tableBorderColor+"'>";
...
{	
	oInstance.Refresh(new Date(current_date));		
}
